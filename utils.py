...
def get_valid_index_arr(game: SpiderSolitaire, valid_moves: Moves) -> List[int]:
    v = []
    for move in valid_moves:
        v.append(game.all_moves.index(move))
    return v


def vectorize_state(game: SpiderSolitaire) -> np.ndarray:
